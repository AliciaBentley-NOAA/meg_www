...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFSv16 Retrospective Case Studies</a></span>
</div>
...
<div id="pageContents">
<center><font size="5">
<img src="https://www.emc.ncep.noaa.gov/users/verification/style/images/gfs4c.png" alt="" width="150" />
<br>
<br>
The National Centers for Environmental Prediction (NCEP) Global Forecast System (GFS) is the cornerstone of NCEP’s operational production suite of numerical guidance. The GFS provides initial and/or boundary conditions for NCEP’s other operational models, including regional, ocean, and wave prediction systems.
<br>
<br>
<a style="color:#ff0000">This webpage contains graphics from the <u>GFSv16 retrospective case studies</u>.
<br>
Please use the links on the left to navigate to GFSv16 retrospective soundings, etc.</a>
<br>
<br>
<b>Additional Information:</b>
<br>
GFSv16 will be the next operational version of GFS. GFSv16 will be a deterministic model that is run 4-times daily (0000, 0600, 1200, and 1800 UTC) out to 16 days. Retrospective forecasts on this webpage are only plotted out to 10 days.  
<br>
<br>
The official evaluation of GFSv16 is scheduled for 8/3/20-9/25/20.
<br>
<a style="color:#1917BE"><b>GFSv16 Official Evaluation Webpage: </b><a href=https://www.emc.ncep.noaa.gov/users/meg/gfsv16/ target="_blank">[click here]</a>.</a>
</center>
</div>
</body>
