...
<a style="color:#FF0000">Left/Right arrow keys = Change forecast lead | Up/Down arrow keys = Change precip. threshold</a>
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    <embed width=100% src="gefs_info_precip_rd.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/html/GEFSv12/retro/SSS/CONUSprcp_RELI_LLL_VVV.gif"
...
levels.push({
        displayName: "35.0 mm/24 h",
        name: "35.0",
});
levels.push({
        displayName: "50.0 mm/24 h",
        name: "50.0",
});
