...
<a style="color:#FF0000">Left/Right arrow keys = Change forecast lead | Up/Down arrow keys = Change statistic</a>
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    <embed width=100% src="gefs_info_precip_ts.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
//var url = "https://www.emc.ncep.noaa.gov/users/meg/gefs_verif/retros/images/noimage.png";
 var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/html/GEFSv12/retro/SSS/CONUSprcp_LLL_TS_VVV.gif"
