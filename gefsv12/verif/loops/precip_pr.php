...
<a style="color:#FF0000">Left/Right arrow keys = Change forecast lead</a>
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    <embed width=100% src="gefs_info_precip_pr.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/html/GEFSv12/retro/SSS/etsbis.fVVV.gif"
