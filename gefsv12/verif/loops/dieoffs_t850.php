...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Ensemble Forecast System v12 (GEFSv12) Verification</a></span>
</div>
...
<a style="color:#FF0000">Left/Right arrow keys = Change statistic | Up/Down arrow keys = Change region</a>
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    <embed width=100% src="gefs_info.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
/* var url = "https://www.emc.ncep.noaa.gov/users/meg/gefs_verif/retros/images/noimage.png"; */
var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/html/GEFSv12/retro/DDDLLL_VVV_SSS.gif";
...
levels.push({
        displayName: "250-hPa u wind",
        name: "u250",
});
levels.push({
        displayName: "250-hPa v wind",
        name: "v250",
});
levels.push({
...
levels.push({
        displayName: "850-hPa u wind",
        name: "u850",
});
levels.push({
        displayName: "850-hPa v wind",
        name: "v850",
});
levels.push({
...
levels.push({
        displayName: "1000-hPa geo. height",
        name: "z1000",
});
levels.push({
...
seasons.push({
        displayName: "All Retros (6/17-11/19)",
        name: "all1719",
});
seasons.push({
        displayName: "Dec 2018-Nov 2019",
        name: "yer1819",
});
seasons.push({
