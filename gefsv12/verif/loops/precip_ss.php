...
<a style="color:#FF0000">Left/Right arrow keys = Change statistic</a>
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    <embed width=100% src="gefs_info_precip_ss.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
// var url = "https://www.emc.ncep.noaa.gov/users/meg/gefs_verif/retros/images/noimage.png";
 var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/html/GEFSv12/retro/SSS/CONUSprcp_VVV.gif"
...
variables.push({
        displayName: "ETS/Bias (35 mm/24 h)",
        name: "ETS_35.0",
});
variables.push({
        displayName: "ETS/Bias (50 mm/24 h)",
        name: "ETS_50.0",
});
variables.push({
...
variables.push({
        displayName: "Brier SS (35 mm/24 h)",
        name: "Brier_35.0",
});
variables.push({
        displayName: "Brier SS (50 mm/24 h)",
        name: "Brier_50.0",
});
